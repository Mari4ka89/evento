...
export default function EventCard({
  event: { name, organizerName, imageUrl, location, date, slug },
}: EventCardProps) {
  ...
  return (
    ...
    rounded-xl overflow-hidden relative state-effects"
      >
        ...
        <section
          className="absolute flex flex-col justify-center items-center left-[12px] top-[12px] 
      h-[45px] w-[45px] bg-black/30 rounded-md"
        >
